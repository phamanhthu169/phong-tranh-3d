...
export class RegisterScene extends BaseScene {
  ...
  _buildForm() {
    ...
    card.style.cssText = 'background:rgba(15,13,12,.97);border:1px solid rgba(212,197,169,.2);border-radius:6px;padding:32px;width:360px;display:flex;flex-direction:column;gap:14px;font-family:monospace;pointer-events:all;';
    card.innerHTML = `
      <div style="color:#d4c5a9;font-size:15px;font-weight:bold;letter-spacing:.18em;text-transform:uppercase;text-align:center;margin-bottom:4px">Tạo hồ sơ</div>

      <div style="display:flex;flex-direction:column;gap:4px">
        <label style="color:#7a6e5c;font-size:9px;letter-spacing:.12em;text-transform:uppercase">Tên hiển thị</label>
      ...
      <div style="display:flex;flex-direction:column;gap:8px">
        <label style="color:#7a6e5c;font-size:9px;letter-spacing:.12em;text-transform:uppercase">Loại tài khoản</label>
      ...
      <div style="border-top:1px solid rgba(212,197,169,.1);padding-top:12px;display:flex;align-items:center;justify-content:space-between">
        <span style="color:#555;font-size:10px;letter-spacing:.06em">Đã có hồ sơ?</span>
